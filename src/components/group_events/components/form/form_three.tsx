...
function FormThree({
  ...
  const formValidationSchema = Yup.object({
    player1_name_200_4: Yup.string().required().label("player 1 Name"),
    player1_phone_200_4: Yup.string().required().label("player 1 Phone"),
    player1_nic_200_4: Yup.string().required().label("player 1 NIC"),
    player1_email_200_4: Yup.string().required().label("player 1 Email"),

    player2_name_200_4: Yup.string().required().label("player 2 Name"),
    player2_nic_200_4: Yup.string().required().label("player 1 NIC"),

    player3_name_200_4: Yup.string().required().label("player 3 Name"),
    player3_nic_200_4: Yup.string().required().label("player 3 NIC"),

    player4_name_200_4: Yup.string().required().label("player 4 Name"),
    player4_nic_200_4: Yup.string().required().label("player 4 NIC"),

    sub_name_200_4: Yup.string().required().label("Sub Player Name"),
    sub_nic_200_4: Yup.string().required().label("Sub Player NIC"),
  });
  return (
    <>
      ...
      <Formik
        ...
        onSubmit={(value) => {
          handleSubmit(value);
          changeGroupEvents("G_200_4", true);
                  ...
                  <div className="mb-3">
                    ...
                    <div className="xl:grid xl:grid-cols-3 xl:gap-3">
                      <div className="mb-2">
                        <Field
                          type="text"
                          id="player1_name_200_4"
                          name="player1_name_200_4"
                      ...
                      <div className="mb-2">
                        <Field
                          type="text"
                          id="player1_phone_200_4"
                          name="player1_phone_200_4"
                      ...
                      <div className="mb-2">
                        <Field
                          type="text"
                          id="player1_nic_200_4"
                          name="player1_nic_200_4"
                      ...
                      <div className="mb-2">
                        <Field
                          type="text"
                          id="player1_email_200_4"
                          name="player1_email_200_4"
                  ...
                  <div className="mb-3">
                    ...
                    <div className="xl:grid xl:grid-cols-3 xl:gap-3">
                      <div className="mb-2">
                        <Field
                          type="text"
                          id="player2_name_200_4"
                          name="player2_name_200_4"
                      ...
                      <div className="mb-2">
                        <Field
                          type="text"
                          id="player2_nic_200_4"
                          name="player2_nic_200_4"
                  ...
                  <div className="mb-3">
                    ...
                    <div className="xl:grid xl:grid-cols-3 xl:gap-3">
                      <div className="mb-2">
                        <Field
                          type="text"
                          id="player3_name_200_4"
                          name="player3_name_200_4"
                      ...
                      <div className="mb-2">
                        <Field
                          type="text"
                          id="player3_nic_200_4"
                          name="player3_nic_200_4"
                  ...
                  <div className="mb-5">
                    ...
                    <div className="xl:grid xl:grid-cols-3 xl:gap-3">
                      <div className="mb-2">
                        <Field
                          type="text"
                          id="player4_name_200_4"
                          name="player4_name_200_4"
                      ...
                      <div className="mb-2">
                        <Field
                          type="text"
                          id="player4_nic_200_4"
                          name="player4_nic_200_4"
